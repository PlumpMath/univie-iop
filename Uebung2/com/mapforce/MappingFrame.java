...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jvlz_509_clean_altova2Label0 = new JLabel();
	JTextField jvlz_509_clean_altova2TextField0 = new JTextField();

	JLabel jvlz_kap_706_clean_edit2Label1 = new JLabel();
	JTextField jvlz_kap_706_clean_edit2TextField1 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2015r3sp1");
	...
	protected void fillScrollPane() {
		...
		jvlz_509_clean_altova2Label0.setText("Source instance of vlz_509_clean_altova.xsd:");
		jvlz_509_clean_altova2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jvlz_509_clean_altova2Label0, null);
		jvlz_509_clean_altova2TextField0.setText("Z:/u/IOP2015/rhoerbe/univie-iop/Uebung2/vlz_509_clean.xml");
		jvlz_509_clean_altova2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jvlz_509_clean_altova2TextField0.setEditable(false);
		jPanelStructures.add(jvlz_509_clean_altova2TextField0, null);

		jvlz_kap_706_clean_edit2Label1.setText("Instance of vlz_kap_706_clean_edit.xsd:");
		jvlz_kap_706_clean_edit2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jvlz_kap_706_clean_edit2Label1, null);
		jvlz_kap_706_clean_edit2TextField1.setText("Z:/u/IOP2015/rhoerbe/univie-iop/Uebung2/vlz_kap_706_clean.xml");
		jvlz_kap_706_clean_edit2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jvlz_kap_706_clean_edit2TextField1.setEditable(false);
		jPanelStructures.add(jvlz_kap_706_clean_edit2TextField1, null);
